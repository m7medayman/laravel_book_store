    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-link active" href="{{route("books.index")}}">All Posts</a>
            </div>
        </div>
        <div class="p-4"><a href="{{route("dashboard")}}">dash board</a></div>
        <div class="p-4"><a href="#" onclick="document.getElementById('logoutform').submit()">logout</a></div>
